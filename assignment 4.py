...
if n >=0:
    ...
    print("Please enter a positive number, as no.of rows must be positive")
print("\n Recursions Method:\n")
...
#Q 6
print("\n Question 6 \n")
print("Barbie and George are here to play a game please help them!!!")
word=input("Enter the word George would say: ")
testword=input("\nEnter a new word that Barbie would think of to test your friendship: ")
...
if count_in_dict(word) !=count_in_dict(testword):
    print("The letter aren't exact, friendship is fake!!")
def userinput():
